...
const initializeProducts = () => {
  if (products.length === 0) {
    products.push(new Product(1, 'Laptop', 'High-performance laptop for work and gaming', 999.99, 130));
    products.push(new Product(2, 'Smartphone', 'Latest model smartphone with advanced features', 699.99, 200));
